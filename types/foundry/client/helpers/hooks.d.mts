...
} from '../appv1/sheets/journal-page-sheet.mjs'
...
type HookParamsClose<
    T extends ApplicationV2,
    N extends string,
> = HookParameters<`close${N}`, [T]>
...
type HookParamsHotbarDrop = HookParameters<
    'hotbarDrop',
    [Hotbar<Macro>, DropCanvasData, string]
>
...
>
type HookParamsRenderChatMessageHTML = HookParameters<
...
export interface DropCanvasData<
